...
builder.ct([1, x], [2, y]).eq([3, z]).strong();
builder.ct([1, x]).ge0().weak();
builder.ct([2, x]).le([5, w]).medium();
builder.ct([1, a], [1, b], [5, 1]).eq0().strong();
