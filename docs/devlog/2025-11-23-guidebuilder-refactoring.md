# 2025-11-23 GuideBuilder 実装の共通化作業

## 作業内容

GuideBuilderX と GuideBuilderY の重複実装を解消し、共通実装 GuideBuilderImpl を作成しました。

## 実施した変更

### 1. 新規ファイル作成: `src/dsl/guide_builder.ts`
...
- 実装ファイル: `src/dsl/guide_builder.ts`
