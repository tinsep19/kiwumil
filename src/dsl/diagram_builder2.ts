...
/**
 * DiagramBuilder2 - Namespace-based DSL version
 * 
 * 新しいプラグインシステムを使った DiagramBuilder
 */
export class DiagramBuilder2<TPlugins extends readonly DiagramPlugin[] = []> {
  ...
  use<TNewPlugins extends readonly DiagramPlugin[]>(
    ...plugins: TNewPlugins
  ): DiagramBuilder2<[...TPlugins, ...TNewPlugins]> {
