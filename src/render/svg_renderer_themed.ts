// src/render/svg_renderer_themed.ts
import type { SymbolBase } from "../model/symbol_base_themed"
...
export class SvgRenderer {
  ...
  constructor(symbols: SymbolBase[], relationships: Association[] = [], theme?: Theme) {
    ...
    // Apply theme to all symbols
    for (const symbol of this.symbols) {
      symbol.setTheme(this.theme)
    }
  }
